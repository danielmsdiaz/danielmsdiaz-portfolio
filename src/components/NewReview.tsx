                ...
                <Card className="text-center h-[330px] flex flex-col items-start gap-y-6">
                    <CardHeader className="flex flex-row w-full justify-start gap-x-2 items-center">
                        ...
                        <div className="flex flex-col items-start text-center w-full">
                            <CardTitle className="font-semibold max-w-[200px] sm:max-w-[100px] xl:max-w-[200px] truncate overflow-hidden text-ellipsis whitespace-nowrap break-words">{item.name}</CardTitle>
                            <CardDescription className="text-sm max-w-[200px] sm:max-w-[100px] xl:max-w-[200px] truncate overflow-hidden text-ellipsis whitespace-nowrap">{item.role}</CardDescription>
                        </div>
                    </CardHeader>
