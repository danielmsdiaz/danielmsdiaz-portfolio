...
const Hero = () => {
    ...
    return (
        <section className="py-12 xl:py-24 sm:h-[84vh] xl:pt-28 dark:bg-none">
            <div className="container mx-auto px-4">
                <div className="flex justify-between gap-x-8">
                    <div className="flex flex-col max-w-[600px] justify-center mx-auto xl:mx-0 text-center xl:text-left">
                        ...
                        <p className="mt-5 subtitle max-w-[600px] mx-auto xl:mx-0">
                            {t("hero.subtitle")}
                        </p>
                        <div className="flex flex-col gap-y-4 md:flex-row gap-x-3 mx-auto xl:mx-0 mb-12">
                            ...
                            <Button variant="secondary" className="gap-x-2 text-base min-w-[170px]">
